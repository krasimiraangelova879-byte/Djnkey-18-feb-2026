export const translations = {
  bg: {
    ...
    nav: {
      ...
      whyChoose: "Защо да изберете DJ NKEY",
      gallery: "Галерия",
      contact: "Контакт"
    },
    // Hero
    ...
    about: {
      ...
      card1Title: "От 2013 година",
      card1Desc: "Над 10 години професионален опит зад пулта със стотици изпълнения.",
      card2Title: "Клубове & Барове",
      card2Desc: "Опит в топ заведения в София и цялата страна с разнообразен музикален стил.",
      card3Title: "Частни събития",
      card3Desc: "Сватби, корпоративни партита, юбилеи, абитуриентски балове и кръщенета."
    },
    // Music Style
    musicStyle: {
      title: "Стил музика",
    ...
    experience: {
      ...
      skillsTitle: "Умения и Сертификати",
      skill1: "Професионално DJ Оборудване",
      skill2: "Музикално Производство",
      skill3: "Звукова Техника",
      skill4: "Светлинни Ефекти"
    },
    // Why Choose
    whyChoose: {
      title: "Защо да изберете DJ NKEY",
      subtitle: "Вашето събитие заслужава най-доброто - професионализъм, качество и страст към музиката",
      reason1: "Над 10 години професионален опит",
      reason1Desc: "Богат опит в DJ индустрията с хиляди успешни изпълнения",
      reason2: "Участия в най-добрите заведения в София и страната",
      reason2Desc: "Работил съм в топ клубове и престижни venues из цяла България",
      reason3: "Опит в работата с едни от най-популярните български изпълнители",
      reason3Desc: "Колаборации и съвместни изпълнения с известни артисти",
      reason4: "Умение да усещам публиката и да изграждам настроение стъпка по стъпка",
      reason4Desc: "Четене на енергията на залата и създаване на перфектната атмосфера",
      reason5: "Перфектно съчетание между класика и модерно звучене",
      reason5Desc: "Миксиране на вечни хитове с най-новите музикални тенденции",
      testimonialQuote: "DJ NKEY направи нашата сватба незабравима! Професионализмът и музикалната селекция бяха на най-високо ниво. Всички гости танцуваха цяла нощ!",
      testimonialAuthor: "Мария и Иван",
      testimonialEvent: "Сватба, София",
    ...
    contact: {
      ...
      message: "Съобщение",
      messagePlaceholder: "Разкажете ми за вашето събитие...",
